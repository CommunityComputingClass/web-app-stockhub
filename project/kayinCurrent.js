...
function preload() {
  ...
  //let url = 'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=IBM&interval=5min&apikey=YOUR_API_KEY';
 // loadJSON(url, processStockData);
...
//function for money if it goes up or down
 if (USD < 10000){
  ...
  stroke(93,115,126)
  strokeWeight(80);
  line(45+(90*i),(((openPrice)-260)*100)-20, 45+(90*i), (((closePrice)-260)*100)+220)
  noStroke()
  }
...
// Example usage:
const startTime = "2025-06-02T10:20:00";
const intervals = 12;
